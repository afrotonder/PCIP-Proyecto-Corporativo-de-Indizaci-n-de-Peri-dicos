<?php
                                ...
                                if(count($Q)){
                                    ...
                                    for( $i = 0; $i < count($Q); $i++){
                                      $newspaper = $Q[$i] ;
                                      if($newspaper and $pcip){
                                        // SELECTS SPECIFIC NEWSPAPER(S) INDEX(ES) THAT ARE IN RELATION WITH ORGANIZATION PCIP
                                        $query = "SELECT T.id_index, T.subject, T.title, T.author, N.newspaper_name, T.page, T.suplement, T.illustration, T.date, O.organization
                                                  FROM tbl_index T, tbl_newspaper N, tbl_organization O
                                                  WHERE T.id_newspaper = N.id_newspaper and T.id_organization = O.id_organization and O.organization = '$pcip' and N.newspaper_name = '$newspaper' ";
                                      }
                                      else if($newspaper and $pucpr){
                                        // SELECTS SPECIFIC NEWSPAPER(S) INDEX(ES) THAT ARE IN RELATION WITH ORGANIZATION PUCPR
                                        $query = "SELECT T.id_index, T.subject, T.title, T.author, N.newspaper_name, T.page, T.suplement, T.illustration, T.date, O.organization
                                                  FROM tbl_index T, tbl_newspaper N, tbl_organization O
                                                  WHERE T.id_newspaper = N.id_newspaper and T.id_organization = O.id_organization and O.organization = '$pucpr' and N.newspaper_name = '$newspaper' ";
                                      }
                                      else if( ($newspaper and $pcip and $pucpr) or ($newspaper)){
                                        // SELECTS SPECIFIC NEWSPAPER(S) INDEX(ES) THAT ARE IN RELATION WITH BOTH ORGANIZATIONS
                                        $query = "SELECT T.id_index, T.subject, T.title, T.author, N.newspaper_name, T.page, T.suplement, T.illustration, T.date, O.organization
                                                  FROM tbl_index T, tbl_newspaper N, tbl_organization O
                                                  WHERE T.id_newspaper = N.id_newspaper and T.id_organization = O.id_organization and N.newspaper_name = '$newspaper' ";
                                      }
