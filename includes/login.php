...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="../index.php">
                <img src="../images/pcip_logo6.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" action="login_check.php" method="post">
                ...
                <!-- MAYBE ADD SIGN IN BY GOOGLE LATER. ONE MAY BE ABLE TO SYNC AND SAVE WORK IN GDRIVE -->
        ...
        <div class="copyright"> 2017 © PCIP Online. </div>
        <!--[if lt IE 9]>
